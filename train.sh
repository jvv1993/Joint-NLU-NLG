...
# data path
train_path='/content/Joint-NLU-NLG/data/'$dataset'_ratio/'$ratio'/train.tsv'
valid_path='/content/Joint-NLU-NLG/data/'$dataset'/dev.tsv'
test_path='/content/Joint-NLU-NLG/data/'$dataset'/test.tsv'
word2count_mr='/content/Joint-NLU-NLG/data/'$dataset'/word2count_mr.json' # word count of meaning representation
word2count_nl='/content/Joint-NLU-NLG/data/'$dataset'/word2count_nl.json' # word count of natural language
